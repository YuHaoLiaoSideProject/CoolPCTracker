...
|---|----------|------|-------------------|----------|----------|
| 1 | **資料 API 載入失敗** | 網路斷線／GitHub Pages 回 404／檔案暫時不可得 | 列表區顯示錯誤狀態：圖示 +「資料載入失敗」+「重試」按鈕 | 不崩潰；保留側欄與搜尋框 UI | 點「重試」重新下載 |
...
- [ ] 資料 API 載入失敗或格式錯誤時顯示錯誤狀態與「重試」按鈕，且頁面不白屏
