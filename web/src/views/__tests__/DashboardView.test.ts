...
vi.mock("@/composables/useDashboardFilters", () => ({
  useDashboardFilters: (items: { value: Item[] }) => ({
    ...
    selectedCapacities: ref(new Set()),
    availableBrands: computed(() => []),
    availableCapacities: computed(() => []),
    availableRpms: computed(() => []),
    selectedRpms: ref(new Set()),
    selectedRamCapacities: ref(new Set()),
    selectedDdrTypes: ref(new Set()),
    selectedInterfaces: ref(new Set()),
    availableRamCapacities: computed(() => []),
    availableDdrTypes: computed(() => []),
    ...
    setPriceMax: vi.fn(),
    toggleBrand: vi.fn(),
    toggleCapacity: vi.fn(),
    toggleRpm: vi.fn(),
    toggleRamCapacity: vi.fn(),
    toggleDdrType: vi.fn(),
